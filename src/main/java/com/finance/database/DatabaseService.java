...
public interface DatabaseService {
    ...
    void deleteTasarrufHedefi(int id);

    // Notlar
    List<Not> getAllNotlar();
    void addNot(Not not);
    void updateNot(Not not);
    void deleteNot(int id);
